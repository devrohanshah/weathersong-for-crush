const weatherKey = "c651d8314aee6fbe7ab93a8960c751ee";
const timeKey = "devrohan";

const token = "pvbkukqkavhttvtf";
const mobile = "+9779765751137";

const audio =
  "https://buibuibucket.s3.amazonaws.com/audio/Sunny+Day/Pharrell_Williams_-_Happy_CeeNaija.com_.mp3";
const message =
  "Hey Avi, as the rain falls, it reminds me of your laughter – a beautiful melody. Wish I could be there to dance in the rain with you. Miss you lots ❤❤❤✨";
...
function sendWhatsapp() {
  ...
  xhr.open("POST", "https://api.ultramsg.com/instance85474/messages/chat");
...
function sendAudio() {
  ...
  xhr.open("POST", "https://api.ultramsg.com/instance85474/messages/audio");
  xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xhr.send(data);
}
